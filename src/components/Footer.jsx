...
const Footer = () => {
  return (
    <div className="flex flex-row bg-dark-blue font-public-sans text-white justify-between p-20">
      ...
      <div className="p-2 text-right space-y-4">
        ...
        <p className="text-grayish-blue">&copy; Easybank. All Rights Reserved</p>
      </div>
    </div>
  );
};
